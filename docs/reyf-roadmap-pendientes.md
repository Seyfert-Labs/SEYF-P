# Reyf — Pendientes y oportunidades de producto

**Versión:** 1.0  
**Fecha:** Junio 2026  
**App:** Reyf (`Seyf2/`)  
**Estado:** Inventario vivo — complementa el [PRD](./reyf-app-prd.md) y la doc de [Etherfuse KYC](./etherfuse-kyc-stablebonds.md).
...
8. [Ideas nuevas alineadas con Reyf](#8-ideas-nuevas-alineadas-con-reyf)
...
| Sandbox SPEI | Portar `POST /api/reyf/etherfuse/sandbox/fiat-received` | 🔴 Alta |
| Dashboard CETES en UI | `dashboard-cetes-saldo`, `cetes-mxne-equiv` en `lib/reyf` sin conectar a Home/bóvedas | 🟡 Media |
...
| Ítem | Detalle | Prioridad |
|------|---------|-----------|
| Auth server-side en `/api/reyf/*` | Scoped por cookie/body; sin JWT Privy | 🟡 Media |
...
| i18n centralizado | seyf-app usaba `messages/es-MX.json`; Reyf textos inline | 🟢 Baja |
...
|---|---------|-----------|---------|
| 1 | **Saldo CETES en Home / bóveda soberana** | Conectar hooks/APIs existentes en `lib/reyf` | Usuario ve valor real del producto soberano |
...
Referencia: [reyf-app-prd.md](./reyf-app-prd.md) §8 Implementation Roadmap.
...
| Tarjeta Reyf | ✅ mock | ❌ | Datos ficticios |
| Plan premium (MoreSheet promos) | ✅ copy | ❌ | Próximamente |

---

## 8. Ideas nuevas alineadas con Reyf
...
| Documento | Contenido |
|-----------|-----------|
| [reyf-app-prd.md](./reyf-app-prd.md) | PRD completo, user stories, roadmap original |
