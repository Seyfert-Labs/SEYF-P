#!/usr/bin/env python3
"""Exporta seyf-pitch.html a PowerPoint. La slide de Solución lleva el video incrustado."""
...
HTML = DOCS / "seyf-pitch.html"
VIDEO = DOCS / "seyf-demo.mp4"
OUT_PPTX = DOCS / "seyf-pitch.pptx"
