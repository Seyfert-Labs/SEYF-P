...
**Versión:** 1.0  
**Fecha:** Junio 2026  
**Autor:** Generado para el equipo de producto de SEYF  
...
SEYF es una plataforma web de ahorro e inversión para el retiro que combina:
...
**Motivación en SEYF:** Proyección clara de cuánto tendrá en 30 años. UI que no se siente como banco del gobierno. Flexibilidad de sacar dinero si lo necesita.  
...
**Motivación en SEYF:** Proyecciones claras de crecimiento patrimonial. Diversificación en instrumentos internacionales. Dashboard de proyección a 20 años.  
...
**Motivación en SEYF:** Simplicidad total, sin jerga financiera. Depósito fácil por SPEI. Perfil conservador con rendimiento real mayor al banco.  
...
**para** acceder a SEYF sin necesidad de conocimientos técnicos ni crypto.
...
**para** que SEYF me asigne la estrategia de inversión más adecuada para mí.
...
| Capa | Tecnología | Justificación |
|---|---|---|
| Red principal (usuario) | Arbitrum (Sepolia testnet / One mainnet) | L2 de Ethereum; MXNB, smart wallets y contratos SeyfVaults |
...
| Contratos bóveda | SeyfVaults + SeyfAdvance (contratos propios) | Lógica de apertura/aportación/retiro y adelanto de liquidez |
...
- **Contratos en Arbitrum:** `SeyfVaults` y `SeyfAdvance` (contratos propios, Arbitrum Sepolia testnet / One mainnet). Manejan apertura, aportación, retiro y adelanto de liquidez.
...
**Wallet Stellar del usuario:** gestionada por **Pollar** (headless, self-custodial). El usuario crea su wallet Stellar con un OTP de email al verificar identidad (KYC). La wallet no es visible directamente en la UI — SEYF la abstrae como parte de la bóveda.
...
| **Diferencial de liquidez** | El usuario recibe MXNB hoy a **0% de costo**; su colateral (1:1) queda bloqueado en la bóveda y sigue generando rendimiento off-chain. SEYF obtiene el diferencial entre el APR de los instrumentos subyacentes (8–14%) y el 0% que adelanta al usuario durante el plazo del advance. Si el usuario nunca repaga manualmente, el rendimiento acumulado cubre la deuda de forma natural. | ✅ Sí |
...
**Objetivo:** Usuario entiende el valor de SEYF vs Afore con proyecciones claras.  
