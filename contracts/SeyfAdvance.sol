...
///         SEYF obtiene el diferencial entre el APR de los instrumentos
...
///         Debe registrarse como `advanceManager` en SeyfVaults.
contract SeyfAdvance is ReentrancyGuard {
    ...
    function requestAdvance(uint256 vaultId, uint256 years_) external nonReentrant whenNotPaused {
        ...
        ISeyfVaults.Vault memory v = vaults.getVault(msg.sender, vaultId);
