...
export type ReyfStellarSession = {
 ...
 * se conduce desde la UI de Reyf con el mismo correo de la sesión Privy, sin
 ...
 */
export function useReyfStellarWallet() {
  ...
  const wallet: ReyfStellarSession | null = useMemo(() => {
