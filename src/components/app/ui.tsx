/* UTONOMA — set de iconos + primitivas SVG (Icon, Flag, Spark, Ring) */
import React from "react";

type IconName =
  | "bell" | "gear" | "plus" | "send" | "recv" | "leaf" | "swap" | "card" | "chart"
...
export function Icon({
  ...
  const paths: Record<string, React.ReactNode> = {
    ...
    in: <><path d="M12 5v13" {...p} /><path d="M6 13l6 6 6-6" {...p} /></>,
    ...
    copy: <><rect x="9" y="9" width="11" height="11" rx="2.5" {...p} /><path d="M5 15V5a2 2 0 012-2h8" {...p} /></>,
